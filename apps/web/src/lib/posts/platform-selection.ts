import type { ConnectionMethod, Prisma, PrismaClient } from "@prisma/client";
import type { Platform } from "@/lib/platforms/types";
import { PLATFORMS } from "@/lib/platforms/types";
import { getProviderCatalogEntry } from "@/lib/providers/catalog";
import type { SettingsSchemaKey } from "@/lib/providers/catalog/types";
import {
...
type DbClient = Pick<PrismaClient, "socialAccount"> | Prisma.TransactionClient;
...
export async function resolvePlatformSelections(params: {
  ...
  const accounts = await params.db.socialAccount.findMany({
    where: {
